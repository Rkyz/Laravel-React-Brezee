...
const CartComponent = ({handleOpenCart}) => {
  return (
    <div className='fixed top-0 w-full max-w-[300px] pt-[96.5px] pr-[10px]  bg-transparent h-full  right-0'>
      ...
      <div className='flex items-center w-full justify-between p-[15px]'>
        ...
        <div className='bg-transparent gap-[15px] p-[15px] flex flex-col w-full h-full max-h-[330px] overflow-y-scroll'>
